# Operator Quickstart — Community Agronomy Support

Shortest path from clone to a verified local dry-run for **ISIC 0162** (`cloud-itonami-isic-0162`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0162.git
cd cloud-itonami-isic-0162
```
...
- Blueprint governor key: `agronomy-governor`
- Likely source path: `agronomyops.governor.cljc`
